...
//! выбирает: канал — это порт [`ImageSource`](ports::ImageSource), который
//! реализует проект. Но вокруг канала есть работа, которая от него не зависит
//! вовсе, и делать её в каждом проекте заново незачем:
//!
