...
закрытого рядом нет, сборка останавливается.** Так выглядит чистая машина, свежий клон
и любой CI — и молча выпущенный там новый ключ дал бы прошивку, которую не примет ни
одно уже прошитое устройство. Нужен новый корень доверия — удалите оба файла, и пара
создастся заново.
